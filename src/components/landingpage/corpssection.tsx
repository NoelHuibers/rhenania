		...
		<section className="w-full bg-gradient-to-br bg-gray-100 py-12 md:py-24 lg:py-32">
			<div className="container mx-auto px-4 md:px-6">
				...
				<div className="flex w-full justify-center">
					<p className="max-w-4xl text-center font-semibold text-xl">
...
const PillarCard: React.FC<PillarCardProps> = ({
	...
	return (
		<div className="group relative h-full min-h-[200px]">
			...
			/>
			<div className="relative flex h-full transform flex-col rounded-lg bg-white p-6 shadow-xl transition-all duration-300 group-hover:-translate-y-2">
