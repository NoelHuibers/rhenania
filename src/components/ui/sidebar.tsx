...
function SidebarProvider({
	...
	const setOpen = React.useCallback(
		(value: boolean | ((value: boolean) => boolean)) => {
			...
			// biome-ignore lint/suspicious/noDocumentCookie: sidebar state cookie is intentional
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: setOpenMobile is a stable setter, Biome false positive
