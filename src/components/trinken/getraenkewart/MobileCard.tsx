						...
						<div className="flex items-center gap-3">
							<div className="group relative h-14 w-14 shrink-0">
								<button
									...
									className="relative block h-full w-full overflow-hidden rounded-md transition-opacity hover:opacity-80 disabled:opacity-50"
							...
							<div className="min-w-0 flex-1">
								{isEditingThis ? (
									...
									<div className="truncate font-medium">{drink.name}</div>
								)}
									...
									<span>
										...
										{isEditingThis ? (
											<Input
												...
												className="inline-block h-6 w-20"
												disabled={isPending}
											/>
										) : (
									...
									<span>
										...
										{isEditingThis ? (
											<Input
												...
												className="inline-block h-6 w-16"
												placeholder="-"
												disabled={isPending}
											/>
										) : drink.volume ? (
