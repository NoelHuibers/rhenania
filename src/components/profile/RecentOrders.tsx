...
export function RecentOrders() {
	...
	// biome-ignore lint/correctness/useExhaustiveDependencies: intentional - these are the filter triggers
	useEffect(() => {
		setCurrentPage(1);
	}, [showOutOfBillOnly, fromDate, toDate]);
			...
			<CardContent className="space-y-4">
				...
				<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
					...
					<div className="hidden items-center gap-4 sm:flex">
						...
						<div className="flex w-auto flex-wrap gap-2 sm:items-end">
								...
								<div key={order.id} className="rounded-lg border p-4">
									<div className="flex items-start justify-between gap-3">
										<div className="min-w-0">
											...
											<p className="truncate font-medium">{order.drinkName}</p>
										</div>
